...
<?php
    ...
    $sql_1 = "SELECT * FROM users_teacher WHERE email='$email'";
    ...
    if(mysqli_num_rows($result_1) > 0){
        ...
        // echo $pass_hash;
        $sql_2="INSERT INTO users_teacher(first_name, last_name, email, password) VALUES ('$first_name','$last_name','$email','$pass_hash')";
